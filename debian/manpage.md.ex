% minio-cpp(SECTION) | User Commands
%
% "October 25 2024"
...
minio-cpp - program to do something

# SYNOPSIS

**minio-cpp** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**minio-cpp** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **minio-cpp** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**minio-cpp** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    minio-cpp. See **foo.conf**(5) for further details.
...
**minio-cpp** provides some return codes, that can be used in scripts:
...
parallels <your_email@example.com>
